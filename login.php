...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if ($user['role'] == 'company_admin') { $_SESSION['company_id'] = $user['company_id']; }
...
<head>
    ...
    <title>Giriş Yap - YokMuOtobüs</title> <link rel="stylesheet" href="styles.css">
</head>
<body>
    <header class="header">
        <div class="logo"><a href="index.php">YokMuOtobüs</a></div>
        <nav class="nav"> <a href="login.php">Giriş Yap</a> <a href="register.php" class="nav-button">Kayıt Ol</a> </nav>
    </header>
    <main class="search-hero">
        <div class="search-widget" style="max-width: 500px;">
            ...
            <?php if ($info_message): ?> <p class="success-message"><?php echo htmlspecialchars($info_message); ?></p> <?php endif; ?>
            <form method="POST" style="text-align: left;">
                ...
                <button type="submit" class="search-button" style="width: 100%; margin-top: 15px; height: auto; padding: 12px;">Giriş Yap</button>
            </form>
