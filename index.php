...
<head>
    ...
    <title>YokMuOtobüs</title> <link rel="stylesheet" href="styles.css">
</head>
<body>
    <header class="header">
    ...
    <main>
        ...
        <section class="content-area">
            ...
            <?php if ($error_message): ?> <p style="text-align: center; color: red;"><?php echo htmlspecialchars($error_message); ?></p> <?php endif; ?>
            <?php if (empty($trips) && !$error_message): ?> <p style="text-align: center; font-size: 18px;">Gösterilecek güncel sefer bulunamadı.</p> <?php endif; ?>
            <div class="trip-list">
